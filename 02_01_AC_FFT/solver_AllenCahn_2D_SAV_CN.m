function [phi, r] = solver_AllenCahn_2D_SAV_CN(pde,domain,Nx,Ny,time,option)
% Allen-Cahn equation
% Reference:
%
%
...
[phi_prev,r_prev] = solver_AllenCahn_2D_SAV_1st(pde,domain,Nx,Ny,time1,option1);
