...
for ss = 1:length(scheme_array)
    ...
    if 1 == strcmp(scheme,'SAV_1st')
        solver_fun = @solver_CahnHilliard_2D_SAV_1st;
    elseif 1 == strcmp(scheme,'SAV_CN')
        solver_fun = @solver_CahnHilliard_2D_SAV_CN;
...
%% results：
% Elapsed time is 59.420314 seconds.
% Accuracy test with reference solution.
% solver_CahnHilliard_2D_SAV_1st
% ex02_CH_2D_data  (epsilon=0.1, S=3, M=1.00e-02, Nx=64, Ny=128, T=0.36)
%    dt      &  Err_phi   & Order 
% 1.6000e-03   2.7220e-05   0.00
% 8.0000e-04   1.3530e-05   1.01
% 4.0000e-04   6.6808e-06   1.02
% 2.0000e-04   3.2551e-06   1.04
% 1.0000e-04   1.5420e-06   1.08
% 
% Elapsed time is 58.168195 seconds.
% Accuracy test with reference solution.
% solver_CahnHilliard_2D_SAV_CN
% ex02_CH_2D_data  (epsilon=0.1, S=3, M=1.00e-02, Nx=64, Ny=128, T=0.36)
%    dt      &  Err_phi   & Order 
% 1.6000e-03   1.2204e-07   0.00
% 8.0000e-04   3.0513e-08   2.00
% 4.0000e-04   7.6263e-09   2.00
% 2.0000e-04   1.9042e-09   2.00
% 1.0000e-04   4.7355e-10   2.01
% 
% Elapsed time is 49.617000 seconds.
% Accuracy test with reference solution.
% solver_CahnHilliard_2D_SAV_BDF
% ex02_CH_2D_data  (epsilon=0.1, S=3, M=1.00e-02, Nx=64, Ny=128, T=0.36)
%    dt      &  Err_phi   & Order 
% 1.6000e-03   1.8478e-07   0.00
% 8.0000e-04   4.6205e-08   2.00
% 4.0000e-04   1.1553e-08   2.00
% 2.0000e-04   2.8892e-09   2.00
% 1.0000e-04   7.2374e-10   2.00
